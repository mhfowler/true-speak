...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ServerMessage'
        db.create_table(u'truespeak_servermessage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('message', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'truespeak', ['ServerMessage'])


    def backwards(self, orm):
        # Deleting model 'ServerMessage'
        db.delete_table(u'truespeak_servermessage')
