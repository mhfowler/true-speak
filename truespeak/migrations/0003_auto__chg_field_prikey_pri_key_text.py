...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PriKey.pri_key_text'
        db.alter_column('truespeak_prikey', 'pri_key_text', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'PriKey.pri_key_text'
        db.alter_column('truespeak_prikey', 'pri_key_text', self.gf('django.db.models.fields.CharField')(max_length=200))
