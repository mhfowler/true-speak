...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ServerMessage.ver_sup'
        db.add_column(u'truespeak_servermessage', 'ver_sup',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ServerMessage.ver_sup'
        db.delete_column(u'truespeak_servermessage', 'ver_sup')
    ...
    models = {
        ...
        u'truespeak.servermessage': {
            ...
            'ver_sup': ('django.db.models.fields.CharField', [], {'default': "'0.0'", 'max_length': '100'})
        },
