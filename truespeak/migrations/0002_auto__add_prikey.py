...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PriKey'
        db.create_table(u'truespeak_prikey', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('pri_key_text', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'truespeak', ['PriKey'])


    def backwards(self, orm):
        # Deleting model 'PriKey'
        db.delete_table(u'truespeak_prikey')
    ...
    models = {
        ...
        u'truespeak.prikey': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pri_key_text': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
