...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.plugin_token'
        db.add_column(u'truespeak_userprofile', 'plugin_token',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=400),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.plugin_token'
        db.delete_column(u'truespeak_userprofile', 'plugin_token')
