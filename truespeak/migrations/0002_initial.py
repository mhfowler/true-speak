...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('truespeak_facebook_user', (
        ...
        db.send_create_signal('truespeak', ['Facebook_User'])

        # Adding model 'UserProfile'
        db.create_table('truespeak_userprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('truespeak', ['UserProfile'])

        # Adding M2M table for field friends on 'UserProfile'
        db.create_table('truespeak_userprofile_friends', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm['truespeak.userprofile'], null=False)),
            ('facebook_user', models.ForeignKey(orm['truespeak.facebook_user'], null=False))
        ))
        db.create_unique('truespeak_userprofile_friends', ['userprofile_id', 'facebook_user_id'])


    def backwards(self, orm):
        # Deleting model 'Facebook_User'
        db.delete_table('truespeak_facebook_user')

        # Deleting model 'UserProfile'
        db.delete_table('truespeak_userprofile')
    ...
    models = {
        ...
        'truespeak.userprofile': {
            'Meta': {'object_name': 'UserProfile'},
            'facebook_user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['truespeak.Facebook_User']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'friends': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'+'", 'null': 'True', 'to': "orm['truespeak.Facebook_User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
